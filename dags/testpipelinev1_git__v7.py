...
_TASK_RESUME_SCOPE_BY_ENTRY = {'timeout_guard_1_node_6': ['delay_2_node_3', 'delay_3_node_4', 'delay_4_node_5', 'timeout_guard_1_node_6'],
 'delay_2_node_3': ['delay_2_node_3', 'delay_3_node_4', 'delay_4_node_5'],
 'delay_3_node_4': ['delay_3_node_4', 'delay_4_node_5'],
 'delay_4_node_5': ['delay_4_node_5']}
...
def testpipelinev1_v7():
    task_node_6 = EmptyOperator(
        task_id='timeout_guard_1_node_6',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_2_node_3')
    def run_node_3():
        delay_minutes = int(1)
        if delay_minutes <= 0:
    ...
    task_node_6 >> task_node_3


dag = testpipelinev1_v7()

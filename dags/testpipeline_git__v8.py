...
_TASK_RESUME_SCOPE_BY_ENTRY = {'delay_1_node_9': ['delay_1_node_9', 'delay_4_node_8', 'timeout_guard_2_node_5', 'timeout_guard_3_node_7'],
 'timeout_guard_2_node_5': ['delay_4_node_8', 'timeout_guard_2_node_5', 'timeout_guard_3_node_7'],
 'timeout_guard_3_node_7': ['delay_4_node_8', 'timeout_guard_3_node_7'],
 'delay_4_node_8': ['delay_4_node_8']}
...
def testpipeline_v8():
    ...
    task_node_5 = EmptyOperator(
        task_id='timeout_guard_2_node_5',
        execution_timeout=timedelta(minutes=int(1)),
    )

    task_node_7 = EmptyOperator(
        task_id='timeout_guard_3_node_7',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_4_node_8')
    def run_node_8():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")

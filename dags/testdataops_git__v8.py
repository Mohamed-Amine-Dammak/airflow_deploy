...
_TASK_RESUME_SCOPE_BY_ENTRY = {'delay_1_node_12': ['delay_1_node_12', 'timeout_guard_2_node_13'],
 'timeout_guard_2_node_13': ['timeout_guard_2_node_13']}
...
def testdataops_v8():
    ...
    task_node_12 = run_node_12()

    task_node_13 = EmptyOperator(
        task_id='timeout_guard_2_node_13',

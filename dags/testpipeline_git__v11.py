...
_TASK_RESUME_SCOPE_BY_ENTRY = {'delay_1_node_14': ['delay_1_node_14',
                     'delay_3_node_10',
                     'delay_5_node_13',
                     'timeout_guard_2_node_11',
                     'timeout_guard_4_node_12'],
 'timeout_guard_2_node_11': ['delay_3_node_10',
                             'delay_5_node_13',
                             'timeout_guard_2_node_11',
                             'timeout_guard_4_node_12'],
 'delay_3_node_10': ['delay_3_node_10', 'delay_5_node_13', 'timeout_guard_4_node_12'],
 'timeout_guard_4_node_12': ['delay_5_node_13', 'timeout_guard_4_node_12'],
 'delay_5_node_13': ['delay_5_node_13']}
...
def testpipeline_v11():
    @task(task_id='delay_1_node_14')
    def run_node_14():
        delay_minutes = int(1)
        if delay_minutes <= 0:
    ...
    task_node_11 = EmptyOperator(
        task_id='timeout_guard_2_node_11',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_3_node_10')
    def run_node_10():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")
    ...
    task_node_12 = EmptyOperator(
        task_id='timeout_guard_4_node_12',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_5_node_13')
    def run_node_13():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")

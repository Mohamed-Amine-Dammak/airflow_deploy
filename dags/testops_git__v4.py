...
_TASK_RESUME_SCOPE_BY_ENTRY = {'talend_1_node_6': ['delay_3_node_1',
                     'delay_4_node_2',
                     'sftp_upload_2_node_4',
                     'sftp_upload_5_node_5',
                     'talend_1_node_6'],
 'sftp_upload_2_node_4': ['delay_3_node_1', 'delay_4_node_2', 'sftp_upload_2_node_4', 'sftp_upload_5_node_5'],
...
def testops_v4():
    ...
    @task(task_id='sftp_upload_2_node_4')
    def run_node_4():
        conn_name = 'sftp'
        action = 'upload'
        local_file_path = 'ok'

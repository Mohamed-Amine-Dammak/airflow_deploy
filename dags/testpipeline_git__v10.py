...
_TASK_RESUME_SCOPE_BY_ENTRY = {'timeout_guard_1_node_11': ['delay_2_node_10',
                             'delay_4_node_13',
                             'timeout_guard_1_node_11',
                             'timeout_guard_3_node_12'],
 'delay_2_node_10': ['delay_2_node_10', 'delay_4_node_13', 'timeout_guard_3_node_12'],
 'timeout_guard_3_node_12': ['delay_4_node_13', 'timeout_guard_3_node_12'],
 'delay_4_node_13': ['delay_4_node_13']}
...
def testpipeline_v10():
    task_node_11 = EmptyOperator(
        task_id='timeout_guard_1_node_11',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_2_node_10')
    def run_node_10():
        delay_minutes = int(1)
        if delay_minutes <= 0:
    ...
    task_node_12 = EmptyOperator(
        task_id='timeout_guard_3_node_12',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_4_node_13')
    def run_node_13():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")

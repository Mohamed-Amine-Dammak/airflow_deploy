...
_TASK_RESUME_SCOPE_BY_ENTRY = {'delay_1_node_15': ['delay_1_node_15',
                     'delay_2_node_14',
                     'delay_4_node_10',
                     'delay_6_node_13',
                     'timeout_guard_3_node_11',
                     'timeout_guard_5_node_12'],
 'delay_2_node_14': ['delay_2_node_14',
                     'delay_4_node_10',
                     'delay_6_node_13',
                     'timeout_guard_3_node_11',
                     'timeout_guard_5_node_12'],
 'timeout_guard_3_node_11': ['delay_4_node_10',
                             'delay_6_node_13',
                             'timeout_guard_3_node_11',
                             'timeout_guard_5_node_12'],
 'delay_4_node_10': ['delay_4_node_10', 'delay_6_node_13', 'timeout_guard_5_node_12'],
 'timeout_guard_5_node_12': ['delay_6_node_13', 'timeout_guard_5_node_12'],
 'delay_6_node_13': ['delay_6_node_13']}
...
def testpipeline_v12():
    @task(task_id='delay_1_node_15')
    def run_node_15():
        delay_minutes = int(1)
        if delay_minutes <= 0:
    ...
    task_node_15 = run_node_15()

    @task(task_id='delay_2_node_14')
    def run_node_14():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")
    ...
    task_node_14 = run_node_14()

    task_node_11 = EmptyOperator(
        task_id='timeout_guard_3_node_11',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_4_node_10')
    def run_node_10():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")
    ...
    task_node_12 = EmptyOperator(
        task_id='timeout_guard_5_node_12',
        execution_timeout=timedelta(minutes=int(1)),
    )

    @task(task_id='delay_6_node_13')
    def run_node_13():
        delay_minutes = int(1)
        if delay_minutes <= 0:
            raise AirflowException("delay.delay_minutes must be > 0.")
    ...
    task_node_13 = run_node_13()

    task_node_10 >> task_node_12
    task_node_11 >> task_node_10
    task_node_12 >> task_node_13
    task_node_14 >> task_node_11
    task_node_15 >> task_node_14


dag = testpipeline_v12()

...
_TASK_RESUME_SCOPE_BY_ENTRY = {'timeout_guard_1_node_6': ['delay_2_node_1',
                            'delay_3_node_3',
                            'delay_4_node_4',
                            'delay_5_node_5',
                            'timeout_guard_1_node_6'],
...
def testpipelinev1_v6():
    ...
    task_node_6 >> task_node_1


dag = testpipelinev1_v6()
